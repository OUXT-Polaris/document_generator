...
function(add_document target)
    ...
    foreach (hh ${headers_hh})
        set(header_spaces "${header_spaces} ${hh}")
    endforeach ()
    file(GLOB_RECURSE headers_hpp ${includedirs}/*.hpp)
    foreach (hpp ${headers_hpp})
    ...
    set(output_path ${CMAKE_CURRENT_BINARY_DIR}/doc/sphinx/html/${target})
